 ...
 */
@Component({
  selector: 'app-currentstud',
  templateUrl: './currentstud.component.html',
  styleUrls: ['./currentstud.component.css']
})



export class CurrentstudComponent implements AfterViewInit {
